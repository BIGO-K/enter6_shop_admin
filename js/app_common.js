...
mm.popup = (function() {
	...
	return {
		...
		open: function(__url, __options) {
			...
			var options = $.extend(true, { _motion: 'up', openElement: null, focus: null, _frameId: null, _frameName: null }, __options);
			var $item = $(''
			...
			$item.find('iframe').attr({ 'id': options._frameId, 'name': options._frameName });
...
mm.modal = (function() {
	...
	return {
		...
		open: function(__target, __options) {
			...
			var options = $.extend(true, { args: [], openElement: null, _frameId: null, _frameName: null }, __options);
...
mm.bom = (function() {
	...
	function bomAppend(__text, __title) {
		...
		setTimeout(function() {
			...
			TweenMax.killDelayedCallsTo(mm.focus.in);
			TweenMax.delayedCall(mm.times._faster, mm.focus.in, [$item.find('.btn_ok')]);
